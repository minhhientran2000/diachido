...
(function(factory) {
    ...
    L.Control.Search = L.Control.extend({
        ...
        onAdd: function(map) {
            ...
            this._splitButton = this._createSplitButton("|", 'split-buttons')
            this._buttonAllProject = this._createButtonNoneSubmit("Danh sách dự án", 'all-project-button')
        ...
        _createButtonNoneSubmit: function(title, className) {
            const button = L.DomUtil.create('a', className, this._container)
            button.href = '#'
            button.title = title
            return button
        },
        _createSplitButton: function(title, className) {
            const splitButton = L.DomUtil.create('span', className, this._container)
            splitButton.innerText = title
        ...
        _recordsFromJsonp: function(text, callAfter) { // extract searched records from remote jsonp service
            ...
            const url = L.Util.template(this._getUrl(text) + '&' + this.options.jsonpParam + '=L.Control.Search.callJsonp', {
                s: text
            }) // parsing url
        ...
        _recordsFromAjax: function(text, callAfter) { // Ajax request
            ...
            */
            ...
            const url = L.Util.template(this._getUrl(text), {
                s: text
            })
