...
! function(t, e) {
    ...
    function t(u, f) {
        ...
        function b(t, e) {
            ...
            var o, r, a = f.minScale,
                i = f.maxScale;
            return e.contain && (r = (e = Z(u)).elem.width / v, o = e.elem.height / v, 1 < r && 1 < o && (r = (e.parent.width - e.parent.border.left - e.parent.border.right) / r, e = (e.parent.height - e.parent.border.top - e.parent.border.bottom) / o, "inside" === f.contain ? i = Math.min(i, r, e) : "outside" === f.contain && (a = Math.max(a, r, e)))), n.scale = Math.min(Math.max(t, a), i), n
        }
